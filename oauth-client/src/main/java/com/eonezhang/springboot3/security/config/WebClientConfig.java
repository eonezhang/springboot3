...
public class WebClientConfig {
    ...
    @Bean
    public OAuth2AuthorizedClientManager auth2AuthorizedClientManager(OAuth2AuthorizedClientRepository authorizedClientRepository, ClientRegistrationRepository clientRegistrationRepository) {
